...
#elif defined (CONFIG_BOARD_OLDMAN)
#define THRES_TOLERANCE	 30
...
#define PS_ALS_SET_PS_TH          (160)	//Customer should change the threshold value according to their mechanical design and measured data
