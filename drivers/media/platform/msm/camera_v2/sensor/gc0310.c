...
static struct msm_camera_i2c_reg_array gc0310_mms_video_setting_list[] = {
	{0xfe, 0xf0},
	{0xfe, 0xf0},
	{0xfe, 0x00},
	{0xfc, 0x0e},
...
//wxl modify for mms video 15fps
 {0xfe,0x00},
 {0x05,0x04},
 {0x06,0x06}, //HB
 {0x07,0x00},
...
static struct msm_camera_i2c_reg_setting gc0310_mms_video_setting[] = {
  {
    .reg_setting = gc0310_mms_video_setting_list,
    .size = ARRAY_SIZE(gc0310_mms_video_setting_list),
    .addr_type = MSM_CAMERA_I2C_BYTE_ADDR,
    .data_type = MSM_CAMERA_I2C_BYTE_DATA,
    .delay = 0,
  },
	...
	void __user *argp)
{
	...
	/*copy from user the desired resoltuion*/
		...
		if (res == MSM_SENSOR_RES_FULL) {
			...
			rc = s_ctrl->sensor_i2c_client->i2c_func_tbl->
				i2c_write_table(
				s_ctrl->sensor_i2c_client, gc0310_mms_video_setting);
				pr_err("%s:%d res =%d\n gc0310_mms_video_setting ",
				__func__, __LINE__, res);
